...
void DemoOutput_Greeting(void)
{
        ...
        Printf("\r\n              LED 2: D9");
    #endif
    #if defined(CCLEE_CUSTOM_PIC18F25K20)
        Printf("\r\n   Input Configuration:");
        Printf("\r\n   Baudrate at 19200");
    #endif
    ...
    #endif
    Printf("\r\n   Demo Instruction:");
    Printf("\r\n   All data received from USART RX will be transmitted via MiWi");
    Printf("\r\n   All data received via MiWi will be forwarded to user through USART TX.");
    Printf("\r\n\r\n");    
